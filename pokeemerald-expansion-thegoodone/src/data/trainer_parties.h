...
static const struct TrainerMon sParty_GruntPetalburgWoods[] = {
    ...
    .lvl = 11,
    .moves = {MOVE_SLUDGE, MOVE_MUD_SHOT, MOVE_WATER_PULSE, MOVE_TOXIC_SPIKES},
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 12,
    .moves = {MOVE_ICE_SHARD, MOVE_BITE, MOVE_METAL_CLAW, MOVE_AERIAL_ACE},
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 11,
    .moves = {MOVE_AQUA_JET, MOVE_BITE, MOVE_POISON_FANG, MOVE_LAST_RESPECTS},
    .nature = TRAINER_PARTY_NATURE(NATURE_JOLLY)
    }
};
...
static const struct TrainerMon sParty_GruntRusturfTunnel[] = {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 20,
    .moves = {MOVE_ACID_SPRAY, MOVE_ANCIENT_POWER, MOVE_CONFUSE_RAY, MOVE_STEALTH_ROCK},
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 19,
    .moves = {MOVE_MUD_BOMB, MOVE_BUBBLE_BEAM, MOVE_SLUDGE_BOMB, MOVE_RAIN_DANCE},
    .nature = TRAINER_PARTY_NATURE(NATURE_MODEST)
    },
    {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 19,
    .moves = {MOVE_BARB_BARRAGE, MOVE_WATERFALL, MOVE_BITE, MOVE_FELL_STINGER},
    .nature = TRAINER_PARTY_NATURE(NATURE_JOLLY)
    },
    {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 20,
    .moves = {MOVE_PSYBEAM, MOVE_HEX, MOVE_HYPNOSIS, MOVE_SWITCHEROO},
    .nature = TRAINER_PARTY_NATURE(NATURE_TIMID)
    },
    {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 19,
    .moves = {MOVE_AIR_SLASH, MOVE_SLUDGE_BOMB, MOVE_GIGA_DRAIN, MOVE_HYPNOSIS},
    .nature = TRAINER_PARTY_NATURE(NATURE_TIMID)
    },
    {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 18,
    .moves = {MOVE_DRAGON_BREATH, MOVE_WATER_PULSE, MOVE_ICY_WIND, MOVE_SUBSTITUTE},
    .nature = TRAINER_PARTY_NATURE(NATURE_TIMID)
    }
};
...
static const struct TrainerMon sParty_GruntMuseum1[] = {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 30,
    .moves = {MOVE_FREEZE_DRY, MOVE_MUD_SHOT, MOVE_MIRROR_COAT, MOVE_YAWN},
    .nature = TRAINER_PARTY_NATURE(NATURE_TIMID)
    },
    {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 30,
    .moves = {MOVE_FUTURE_SIGHT, MOVE_SLUDGE, MOVE_ENERGY_BALL, MOVE_CALM_MIND},
    .nature = TRAINER_PARTY_NATURE(NATURE_MODEST)
    },
    {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 30,
    .moves = {MOVE_AURORA_BEAM, MOVE_CHILLING_WATER, MOVE_WHIRLPOOL, MOVE_PROTECT},
    .nature = TRAINER_PARTY_NATURE(NATURE_TIMID)
    }
};
...
static const struct TrainerMon sParty_GruntMuseum2[] = {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 31,
    .moves = {MOVE_TRIPLE_DIVE, MOVE_THROAT_CHOP, MOVE_STOMPING_TANTRUM, MOVE_DOUBLE_TEAM},
    .nature = TRAINER_PARTY_NATURE(NATURE_JOLLY)
    },
    {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 30,
    .moves = {MOVE_KNOCK_OFF, MOVE_BONE_RUSH, MOVE_PROTECT, MOVE_ROOST},
    .nature = TRAINER_PARTY_NATURE(NATURE_JOLLY)
    }
};
...
static const struct TrainerMon sParty_Wilton1[] = {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 42,
    .moves = {MOVE_LEAF_STORM, MOVE_SEED_BOMB, MOVE_ROCK_SLIDE, MOVE_ACROBATICS},
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 41,
    .moves = {MOVE_SURF, MOVE_ICE_BEAM, MOVE_FOCUS_BLAST, MOVE_CALM_MIND},
    .nature = TRAINER_PARTY_NATURE(NATURE_TIMID)
    },
    {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 41,
    .moves = {MOVE_CROSS_CHOP, MOVE_STONE_EDGE, MOVE_KNOCK_OFF, MOVE_POISON_JAB},
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 42,
    .moves = {MOVE_FIRE_LASH, MOVE_SCORCHING_SANDS, MOVE_THUNDER_PUNCH, MOVE_GIGA_DRAIN},
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 70,
    .moves = {MOVE_EARTHQUAKE, MOVE_STONE_EDGE, MOVE_REVERSAL, MOVE_HONE_CLAWS},
    .nature = TRAINER_PARTY_NATURE(NATURE_JOLLY)
    }
};
...
static const struct TrainerMon sParty_Brooke1[] = {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 42,
    .moves = {MOVE_EARTHQUAKE, MOVE_STONE_EDGE, MOVE_AMNESIA, MOVE_SLACK_OFF},
    .nature = TRAINER_PARTY_NATURE(NATURE_CAREFUL)
    },
    {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 42,
    .moves = {MOVE_STONE_EDGE, MOVE_AVALANCHE, MOVE_MIRROR_COAT, MOVE_STEALTH_ROCK},
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 41,
    .moves = {MOVE_BOLT_BEAK, MOVE_DRAGON_RUSH, MOVE_IRON_TAIL, MOVE_STOMPING_TANTRUM},
    .nature = TRAINER_PARTY_NATURE(NATURE_ADAMANT)
    },
    {
    .species = SPECIES_HARIYAMA,
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 42,
    .moves = {MOVE_HEAVY_SLAM, MOVE_SUPERPOWER, MOVE_STONE_EDGE, MOVE_CURSE},
    .nature = TRAINER_PARTY_NATURE(NATURE_ADAMANT)
    },
    {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 41,
    .moves = {MOVE_LAST_RESPECTS, MOVE_PLAY_ROUGH, MOVE_CRUNCH, MOVE_BODY_PRESS},
    .nature = TRAINER_PARTY_NATURE(NATURE_ADAMANT)
    }
};
...
static const struct TrainerMon sParty_Cindy1[] = {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 11,
    .moves = {MOVE_ANCIENT_POWER, MOVE_SOFT_BOILED, MOVE_SWEET_KISS, MOVE_THUNDER_WAVE},
    .nature = TRAINER_PARTY_NATURE(NATURE_TIMID)
    },
    {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 10,
    .moves = {MOVE_THUNDER_FANG, MOVE_TRAILBLAZE, MOVE_SWEET_KISS, MOVE_NUZZLE},
    .nature = TRAINER_PARTY_NATURE(NATURE_JOLLY)
    },
    {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 10,
    .moves = {MOVE_INCINERATE, MOVE_HEX, MOVE_HYPNOSIS, MOVE_WILL_O_WISP},
    .nature = TRAINER_PARTY_NATURE(NATURE_TIMID)
    }
};
...
static const struct TrainerMon sParty_Daisuke[] = {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 41,
    .moves = {MOVE_SURF, MOVE_BOUNCE, MOVE_ENDURE, MOVE_EXPLOSION},
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 42,
    .moves = {MOVE_HEAVY_SLAM, MOVE_DRAGON_CLAW, MOVE_INFESTATION, MOVE_PROTECT},
    .nature = TRAINER_PARTY_NATURE(NATURE_JOLLY)
    },
    {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 41,
    .moves = {MOVE_POWER_WHIP, MOVE_HI_JUMP_KICK, MOVE_TRIPLE_AXEL, MOVE_FACADE},
    .nature = TRAINER_PARTY_NATURE(NATURE_JOLLY)
    },
    {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 41,
    .moves = {MOVE_AIR_SLASH, MOVE_EXTRASENSORY, MOVE_WATER_PULSE, MOVE_CALM_MIND},
    .nature = TRAINER_PARTY_NATURE(NATURE_TIMID)
    },
    {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 40,
    .moves = {MOVE_BARB_BARRAGE, MOVE_CRUNCH, MOVE_WATERFALL, MOVE_DESTINY_BOND},
    .nature = TRAINER_PARTY_NATURE(NATURE_JOLLY)
    },
    {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 42,
    .moves = {MOVE_GIGATON_HAMMER, MOVE_PLAY_ROUGH, MOVE_ICE_HAMMER, MOVE_ROCK_SLIDE},
    .nature = TRAINER_PARTY_NATURE(NATURE_JOLLY)
    }
};
...
static const struct TrainerMon sParty_Sidney[] = {
    ...
    .lvl = 100,
    .moves = {MOVE_DARK_PULSE, MOVE_SHADOW_BALL, MOVE_DARK_VOID, MOVE_TRICK_ROOM},
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 0),
    .lvl = 100,
    .moves = {MOVE_KOWTOW_CLEAVE, MOVE_IRON_HEAD, MOVE_ZEN_HEADBUTT, MOVE_REVERSAL},
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 0),
    .lvl = 100,
    .moves = {MOVE_STOMPING_TANTRUM, MOVE_RUINATION, MOVE_BODY_PRESS, MOVE_HEAVY_SLAM},
    .nature = TRAINER_PARTY_NATURE(NATURE_BRAVE)
    },
    {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 0),
    .lvl = 100,
    .moves = {MOVE_KNOCK_OFF, MOVE_HEAVY_SLAM, MOVE_GUNK_SHOT, MOVE_TRICK_ROOM},
    .nature = TRAINER_PARTY_NATURE(NATURE_BRAVE)
    },
    {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 0),
    .lvl = 100,
    .moves = {MOVE_TRI_ATTACK, MOVE_PSYCHIC, MOVE_CHARGE_BEAM, MOVE_TRICK_ROOM},
    .nature = TRAINER_PARTY_NATURE(NATURE_QUIET)
    },
    {
    .species = SPECIES_MAWILE,
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 0),
    .lvl = 100,
    .moves = {MOVE_PLAY_ROUGH, MOVE_IRON_HEAD, MOVE_SUCKER_PUNCH, MOVE_ICE_FANG},
    .nature = TRAINER_PARTY_NATURE(NATURE_BRAVE)
    }
};
...
static const struct TrainerMon sParty_Phoebe[] = {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 100,
    .moves = {MOVE_AXE_KICK, MOVE_ZEN_HEADBUTT, MOVE_ROCK_SLIDE, MOVE_FAKE_OUT},
    .nature = TRAINER_PARTY_NATURE(NATURE_JOLLY)
    },
    {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 99,
    .moves = {MOVE_RAGE_FIST, MOVE_CLOSE_COMBAT, MOVE_GUNK_SHOT, MOVE_BULK_UP},
    .nature = TRAINER_PARTY_NATURE(NATURE_JOLLY)
    },
    {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 100,
    .moves = {MOVE_MAKE_IT_RAIN, MOVE_SHADOW_BALL, MOVE_POWER_GEM, MOVE_NASTY_PLOT},
    .nature = TRAINER_PARTY_NATURE(NATURE_TIMID)
    },
    {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 99,
    .moves = {MOVE_FUTURE_SIGHT, MOVE_NIGHT_DAZE, MOVE_THUNDERBOLT, MOVE_FAKE_OUT},
    .nature = TRAINER_PARTY_NATURE(NATURE_TIMID)
    },
    {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 99,
    .moves = {MOVE_ASTRAL_BARRAGE, MOVE_POLLEN_PUFF, MOVE_DRAINING_KISS, MOVE_REFLECT},
    .nature = TRAINER_PARTY_NATURE(NATURE_TIMID)
    }
};
...
static const struct TrainerMon sParty_Glacia[] = {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 100,
    .moves = {MOVE_BLIZZARD, MOVE_GIGA_DRAIN, MOVE_EARTH_POWER, MOVE_TRAILBLAZE},
    .nature = TRAINER_PARTY_NATURE(NATURE_TIMID)
    },
    {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 100,
    .moves = {MOVE_HYDRO_PUMP, MOVE_GRASS_KNOT, MOVE_ICY_WIND, MOVE_STEALTH_ROCK},
    .nature = TRAINER_PARTY_NATURE(NATURE_TIMID)
    },
    {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 99,
    .moves = {MOVE_BOLT_BEAK, MOVE_BLIZZARD, MOVE_THUNDERBOLT, MOVE_METEOR_BEAM},
    .nature = TRAINER_PARTY_NATURE(NATURE_HASTY)
    },
    {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 99,
    .moves = {MOVE_FREEZING_GLARE, MOVE_HURRICANE, MOVE_TAILWIND, MOVE_DOUBLE_TEAM},
    .nature = TRAINER_PARTY_NATURE(NATURE_MODEST)
    },
    {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 100,
    .moves = {MOVE_ICICLE_SPEAR, MOVE_SCALE_SHOT, MOVE_EARTHQUAKE, MOVE_IRON_HEAD},
    .nature = TRAINER_PARTY_NATURE(NATURE_JOLLY)
    },
    {
...
static const struct TrainerMon sParty_Roxanne1[] = {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 16,
    .moves = {MOVE_ROCK_TOMB, MOVE_DRAGON_TAIL, MOVE_FIRE_FANG, MOVE_ICE_FANG},
    .nature = TRAINER_PARTY_NATURE(NATURE_JOLLY)
    },
    {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 16,
    .moves = {MOVE_WATERFALL, MOVE_ROCK_SLIDE, MOVE_BULLDOZE, MOVE_REST},
    .nature = TRAINER_PARTY_NATURE(NATURE_JOLLY)
    },
    {
    .species = SPECIES_MAGCARGO,
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 15,
    .moves = {MOVE_ANCIENT_POWER, MOVE_INCINERATE, MOVE_EARTH_POWER, MOVE_SHELL_SMASH},
    .nature = TRAINER_PARTY_NATURE(NATURE_MODEST)
    },
    {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 15,
    .moves = {MOVE_SALT_CURE, MOVE_HEAVY_SLAM, MOVE_PROTECT, MOVE_NONE},
    .nature = TRAINER_PARTY_NATURE(NATURE_CAREFUL)
    },
    {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 16,
    .moves = {MOVE_OMINOUS_WIND, MOVE_ANCIENT_POWER, MOVE_WATER_PULSE, MOVE_WILL_O_WISP},
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 17,
    .moves = {MOVE_PLUCK, MOVE_ROCK_BLAST, MOVE_STEEL_WING, MOVE_U_TURN},
    .nature = TRAINER_PARTY_NATURE(NATURE_JOLLY)
    }
};
...
static const struct TrainerMon sParty_Brawly1[] = {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 25,
    .moves = {MOVE_TEMPER_FLARE, MOVE_BODY_PRESS, MOVE_WILD_CHARGE, MOVE_TRAILBLAZE},
    .nature = TRAINER_PARTY_NATURE(NATURE_JOLLY)
    },
    {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 24,
    .moves = {MOVE_BRICK_BREAK, MOVE_POISON_JAB, MOVE_THROAT_CHOP, MOVE_ROCK_SLIDE},
    .nature = TRAINER_PARTY_NATURE(NATURE_JOLLY)
    },
    {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 24,
    .moves = {MOVE_THUNDER_PUNCH, MOVE_DRAIN_PUNCH, MOVE_ICE_PUNCH, MOVE_THUNDER_WAVE},
    .nature = TRAINER_PARTY_NATURE(NATURE_ADAMANT)
    },
    {
    ...
    .iv = TRAINER_PARTY_IVS (31,31,31,31,31,31),
    .lvl = 24,
    .moves = {MOVE_DRAIN_PUNCH, MOVE_VENOSHOCK, MOVE_FOUL_PLAY, MOVE_SHADOW_BALL},
    .nature = TRAINER_PARTY_NATURE(NATURE_HASTY),
    },
    {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 23,
    .moves = {MOVE_SHADOW_SNEAK, MOVE_ROCK_SMASH, MOVE_THUNDER_PUNCH, MOVE_GRASS_KNOT},
    .nature = TRAINER_PARTY_NATURE(NATURE_JOLLY)
    },
    {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 25,
    .moves = {MOVE_DRILL_PECK, MOVE_CROSS_CHOP, MOVE_NIGHT_SLASH, MOVE_LEAF_BLADE},
    .nature = TRAINER_PARTY_NATURE(NATURE_JOLLY)
    },
};
...
static const struct TrainerMon sParty_Wattson1[] = {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 36,
    .moves = {MOVE_DISCHARGE, MOVE_CLOSE_COMBAT, MOVE_SEED_BOMB, MOVE_FAKE_OUT},
    .nature = TRAINER_PARTY_NATURE(NATURE_NAIVE)
    },
    {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 36,
    .moves = {MOVE_DISCHARGE, MOVE_HIGH_HORSEPOWER, MOVE_OVERHEAT, MOVE_TRAILBLAZE},
    ...
    .lvl = 35,
    .moves = {MOVE_DISCHARGE, MOVE_FLAMETHROWER, MOVE_HIDDEN_POWER, MOVE_SNARL},
    .nature = TRAINER_PARTY_NATURE(NATURE_MODEST)
    },
    {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 36,
    .moves = {MOVE_DISCHARGE, MOVE_EARTH_POWER, MOVE_FLAMETHROWER, MOVE_ICE_BEAM},
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 35,
    .moves = {MOVE_DISCHARGE, MOVE_ACROBATICS, MOVE_HEAT_WAVE, MOVE_DETECT},
    .nature = TRAINER_PARTY_NATURE(NATURE_NAIVE)
    },
    {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 36,
    .moves = {MOVE_MEGA_DRAIN, MOVE_DRAGON_BREATH, MOVE_AURA_SPHERE, MOVE_ROCK_SLIDE},
    .nature = TRAINER_PARTY_NATURE(NATURE_NAIVE)
    }
};
...
static const struct TrainerMon sParty_Flannery1[] = {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 56,
    .moves = {MOVE_FIRE_PUNCH, MOVE_CLOSE_COMBAT, MOVE_KNOCK_OFF, MOVE_STEALTH_ROCK},
    .nature = TRAINER_PARTY_NATURE(NATURE_JOLLY)
    },
    {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 56,
    .moves = {MOVE_HEAT_WAVE, MOVE_SLUDGE_WAVE, MOVE_SOLAR_BEAM, MOVE_TOXIC_SPIKES},
    .nature = TRAINER_PARTY_NATURE(NATURE_TIMID)
    },
    {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 55,
    .moves = {MOVE_BITTER_BLADE, MOVE_SOLAR_BLADE, MOVE_X_SCISSOR, MOVE_SHADOW_SNEAK},
    .nature = TRAINER_PARTY_NATURE(NATURE_JOLLY)
    },
    {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 55,
    .moves = {MOVE_FIERY_WRATH, MOVE_HURRICANE, MOVE_FIRE_SPIN, MOVE_NASTY_PLOT},
    .nature = TRAINER_PARTY_NATURE(NATURE_TIMID)
    },
    {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 56,
    .moves = {MOVE_FLAMETHROWER, MOVE_DARK_PULSE, MOVE_SOLAR_BEAM, MOVE_DESTINY_BOND},
    .nature = TRAINER_PARTY_NATURE(NATURE_TIMID)
    }
};
...
static const struct TrainerMon sParty_Norman1[] = {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 60,
    .moves = {MOVE_CLOSE_COMBAT, MOVE_RETURN, MOVE_FACADE, MOVE_FAKE_OUT},
    .nature = TRAINER_PARTY_NATURE(NATURE_JOLLY)
    },
    {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 60,
    .moves = {MOVE_RETALIATE, MOVE_DRAGON_RUSH, MOVE_IRON_TAIL, MOVE_SHED_TAIL},
    .nature = TRAINER_PARTY_NATURE(NATURE_JOLLY)
    },
    {
    .species = SPECIES_WIGGLYTUFF,
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 61,
    .moves = {MOVE_MOONBLAST, MOVE_PSYCHIC, MOVE_CALM_MIND, MOVE_SING},
    .nature = TRAINER_PARTY_NATURE(NATURE_TIMID)
    },
    {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 59,
    .moves = {MOVE_BLOOD_MOON, MOVE_HYPER_VOICE, MOVE_EARTH_POWER, MOVE_MOONLIGHT},
    .nature = TRAINER_PARTY_NATURE(NATURE_MODEST)
    },
    {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 60,
    .moves = {MOVE_MULTI_ATTACK, MOVE_ZEN_HEADBUTT, MOVE_CRUNCH, MOVE_IRON_HEAD},
    .nature = TRAINER_PARTY_NATURE(NATURE_JOLLY)
    },
    {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 60,
    .moves = {MOVE_THUNDERBOLT, MOVE_SHADOW_BALL, MOVE_ICE_BEAM, MOVE_MAGNET_RISE},
    .nature = TRAINER_PARTY_NATURE(NATURE_TIMID)
    }
};
...
static const struct TrainerMon sParty_Winona1[] = {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 70,
    .moves = {MOVE_ACROBATICS, MOVE_SHADOW_BALL, MOVE_HELPING_HAND, MOVE_TAILWIND},
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 71,
    .moves = {MOVE_LEAF_BLADE, MOVE_KNOCK_OFF, MOVE_FOCUS_BLAST, MOVE_FAKE_OUT},
    .nature = TRAINER_PARTY_NATURE(NATURE_NAIVE)
    },
    {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 71,
    .moves = {MOVE_RETURN, MOVE_CLOSE_COMBAT, MOVE_EARTHQUAKE, MOVE_STONE_EDGE},
    .nature = TRAINER_PARTY_NATURE(NATURE_JOLLY)
    },
    {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 69,
    .moves = {MOVE_EARTH_POWER, MOVE_PSYCHIC, MOVE_GRASS_KNOT, MOVE_PROTECT},
    .nature = TRAINER_PARTY_NATURE(NATURE_TIMID)
    },
    {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 69,
    .moves = {MOVE_PLAY_ROUGH, MOVE_POISON_TAIL, MOVE_LASH_OUT, MOVE_SWORDS_DANCE},
    .nature = TRAINER_PARTY_NATURE(NATURE_JOLLY)
    },
    {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 70,
    .moves = {MOVE_DRAGON_RUSH, MOVE_HURRICANE, MOVE_FIRE_BLAST, MOVE_ROOST},
    .nature = TRAINER_PARTY_NATURE(NATURE_NAIVE)
    }
};
...
static const struct TrainerMon sParty_Calvin1[] = {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 1,
    .moves = {MOVE_LEER, MOVE_TAIL_WHIP, MOVE_NONE, MOVE_NONE},
    .nature = TRAINER_PARTY_NATURE(NATURE_JOLLY)
    },
    {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 1,
    .moves = {MOVE_AROMATHERAPY, MOVE_TAIL_WHIP, MOVE_LEER, MOVE_NONE},
    .nature = TRAINER_PARTY_NATURE(NATURE_ADAMANT)
    },
    {
    .species = SPECIES_TORKOAL,
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 1,
    .moves = {MOVE_EMBER, MOVE_GROWL, MOVE_STEALTH_ROCK, MOVE_NONE},
    .nature = TRAINER_PARTY_NATURE(NATURE_ADAMANT)
    }
};
...
static const struct TrainerMon sParty_Billy[] = {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 9,
    .moves = {MOVE_AQUA_JET, MOVE_ROCK_SMASH, MOVE_ICE_PUNCH, MOVE_ROLLOUT},
    .nature = TRAINER_PARTY_NATURE(NATURE_ADAMANT)
    },
    {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 10,
    .moves = {MOVE_HEADBUTT, MOVE_PAYBACK, MOVE_ROLLOUT, MOVE_DEFENSE_CURL},
    .nature = TRAINER_PARTY_NATURE(NATURE_BRAVE)
    },
    {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 9,
    .moves = {MOVE_WATER_PULSE, MOVE_ICY_WIND, MOVE_MUD_SLAP, MOVE_WHIRLPOOL},
    .nature = TRAINER_PARTY_NATURE(NATURE_MODEST)
    }
};
...
static const struct TrainerMon sParty_Josh2[] = {
    {
    .iv = TRAINER_PARTY_IVS(13, 13, 13, 13, 13, 13),
    .lvl = 8,
    .species = SPECIES_GEODUDE,
...
static const struct TrainerMon sParty_Tommy2[] = {
    {
    .iv = TRAINER_PARTY_IVS(13, 13, 13, 13, 13, 13),
    .lvl = 8,
    .species = SPECIES_GEODUDE,
...
static const struct TrainerMon sParty_Joey2[] = {
    {
    .iv = TRAINER_PARTY_IVS(13, 13, 13, 13, 13, 13),
    .lvl = 8,
    .species = SPECIES_GEODUDE,
...
static const struct TrainerMon sParty_Dillon[] = {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 47,
    .moves = {MOVE_POPULATION_BOMB, MOVE_BULLET_SEED, MOVE_BARRAGE, MOVE_FOLLOW_ME},
    .nature = TRAINER_PARTY_NATURE(NATURE_JOLLY)
    },
    {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 48,
    .moves = {MOVE_AIR_SLASH, MOVE_ELECTROWEB, MOVE_SUBSTITUTE, MOVE_BATON_PASS},
    .nature = TRAINER_PARTY_NATURE(NATURE_TIMID)
    },
    {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 46,
    .moves = {MOVE_ATTACK_ORDER, MOVE_ACROBATICS, MOVE_HELPING_HAND, MOVE_DEFEND_ORDER},
    .nature = TRAINER_PARTY_NATURE(NATURE_ADAMANT)
    }
};
...
static const struct TrainerMon sParty_Allen[] = {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 8,
    .moves = {MOVE_RAZOR_LEAF, MOVE_PLUCK, MOVE_SHADOW_SNEAK, MOVE_NONE},
    .nature = TRAINER_PARTY_NATURE(NATURE_ADAMANT)
    },
    {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 8,
    .moves = {MOVE_AQUA_JET, MOVE_BITE, MOVE_ICE_FANG, MOVE_ROCK_TOMB},
    .nature = TRAINER_PARTY_NATURE(NATURE_ADAMANT)
    },
    {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 8,
    .moves = {MOVE_FLAME_CHARGE, MOVE_PSYBEAM, MOVE_FIRE_SPIN, MOVE_HYPNOSIS},
    .nature = TRAINER_PARTY_NATURE(NATURE_HASTY)
    }
};
...
static const struct TrainerMon sParty_Ivan[] = {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 15,
    .moves = {MOVE_DAZZLING_GLEAM, MOVE_SURF, MOVE_FLAMETHROWER, MOVE_STICKY_WEB},
    .nature = TRAINER_PARTY_NATURE(NATURE_TIMID)
    },
    {
    .species = SPECIES_MEW,
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 15,
    .moves = {MOVE_SWIFT, MOVE_HEX, MOVE_HYPNOSIS, MOVE_WILL_O_WISP},
    .nature = TRAINER_PARTY_NATURE(NATURE_TIMID)
    },
    {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 15,
    .moves = {MOVE_HEADBUTT, MOVE_FORCE_PALM, MOVE_ZEN_HEADBUTT, MOVE_PAYBACK},
    .nature = TRAINER_PARTY_NATURE(NATURE_JOLLY)
    },
    {
    .species = SPECIES_ROSELIA,
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 15,
    .moves = {MOVE_SLUDGE, MOVE_GIGA_DRAIN, MOVE_EXTRASENSORY, MOVE_SLEEP_POWDER},
    .nature = TRAINER_PARTY_NATURE(NATURE_TIMID)
    },
    {
    .species = SPECIES_BEAUTIFLY,
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 15,
    .moves = {MOVE_SILVER_WIND, MOVE_AIR_CUTTER, MOVE_GIGA_DRAIN, MOVE_STUN_SPORE},
    .nature = TRAINER_PARTY_NATURE(NATURE_MODEST)
    }
};
...
static const struct TrainerMon sParty_Elliot1[] = {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 24,
    .moves = {MOVE_DAZZLING_GLEAM, MOVE_STORED_POWER, MOVE_ENERGY_BALL, MOVE_CALM_MIND},
    .nature = TRAINER_PARTY_NATURE(NATURE_BOLD)
    },
    {
    .species = SPECIES_LOPUNNY,
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 23,
    .moves = {MOVE_BODY_SLAM, MOVE_JUMP_KICK, MOVE_BOUNCE, MOVE_U_TURN},
    .nature = TRAINER_PARTY_NATURE(NATURE_JOLLY)
    },
    {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 24,
    .moves = {MOVE_MUDDY_WATER, MOVE_ICY_WIND, MOVE_SUBSTITUTE, MOVE_ACID_ARMOR},
    .nature = TRAINER_PARTY_NATURE(NATURE_TIMID)
    },
    {
    .species = SPECIES_MAWILE,
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 24,
    .moves = {MOVE_PLAY_ROUGH, MOVE_IRON_HEAD, MOVE_ICE_FANG, MOVE_SUCKER_PUNCH},
    .nature = TRAINER_PARTY_NATURE(NATURE_ADAMANT)
    }
};
...
static const struct TrainerMon sParty_MayRoute110Mudkip[] = {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 32,
    .moves = {MOVE_BODY_PRESS, MOVE_SAND_TOMB, MOVE_STEALTH_ROCK, MOVE_SELF_DESTRUCT},
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 30,
    .moves = {MOVE_WATERFALL, MOVE_BOUNCE, MOVE_CRUNCH, MOVE_BULLDOZE},
    .nature = TRAINER_PARTY_NATURE(NATURE_JOLLY)
    },
    {
    .species = SPECIES_NINETALES,
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 30,
    .moves = {MOVE_FLAMETHROWER, MOVE_SHADOW_BALL, MOVE_ENERGY_BALL, MOVE_NASTY_PLOT},
    .nature = TRAINER_PARTY_NATURE(NATURE_TIMID)
    },
    {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 31,
    .moves = {MOVE_DYNAMIC_PUNCH, MOVE_FACADE, MOVE_ICE_PUNCH, MOVE_THUNDER_PUNCH},
    .nature = TRAINER_PARTY_NATURE(NATURE_JOLLY)
    },
    {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 32,
    .moves = {MOVE_BULLET_SEED, MOVE_PLAY_ROUGH, MOVE_BITE, MOVE_U_TURN},
    .nature = TRAINER_PARTY_NATURE(NATURE_JOLLY)
    }
};
...
static const struct TrainerMon sParty_MayRoute110Treecko[] = {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 31,
    .moves = {MOVE_FORCE_PALM, MOVE_BULLET_SEED, MOVE_ROCK_TOMB, MOVE_SPORE},
    .nature = TRAINER_PARTY_NATURE(NATURE_JOLLY)
    },
    {
    .species = SPECIES_GYARADOS,
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 30,
    .moves = {MOVE_ICE_BEAM, MOVE_HEX, MOVE_THUNDERBOLT, MOVE_WILL_O_WISP},
    .nature = TRAINER_PARTY_NATURE(NATURE_TIMID)
    },
    {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 32,
    .moves = {MOVE_FLAME_CHARGE, MOVE_LOW_SWEEP, MOVE_SUCKER_PUNCH, MOVE_TRAILBLAZE},
    .nature = TRAINER_PARTY_NATURE(NATURE_ADAMANT)
    }
};
...
static const struct TrainerMon sParty_MayRoute119Torchic[] = {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 31,
    .moves = {MOVE_DUAL_WINGBEAT, MOVE_KNOCK_OFF, MOVE_ROCK_SLIDE, MOVE_ROOST},
    .nature = TRAINER_PARTY_NATURE(NATURE_JOLLY)
    },
    {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 32,
    .moves = {MOVE_WATER_SHURIKEN, MOVE_ICE_BEAM, MOVE_MUD_SHOT, MOVE_GRASS_KNOT},
    .nature = TRAINER_PARTY_NATURE(NATURE_TIMID)
    }
};
...
static const struct TrainerMon sParty_TabithaMtChimney[] = {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 51,
    .moves = {MOVE_STONE_EDGE, MOVE_PAYBACK, MOVE_ZEN_HEADBUTT, MOVE_IRON_HEAD},
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 49,
    .moves = {MOVE_IRON_TAIL, MOVE_EARTHQUAKE, MOVE_STEALTH_ROCK, MOVE_SHED_TAIL},
    .nature = TRAINER_PARTY_NATURE(NATURE_JOLLY)
    },
    {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 49,
    .moves = {MOVE_FLARE_BLITZ, MOVE_STONE_EDGE, MOVE_WILD_CHARGE, MOVE_HOWL},
    .nature = TRAINER_PARTY_NATURE(NATURE_JOLLY)
    },
    {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 49,
    .moves = {MOVE_EARTHQUAKE, MOVE_CLOSE_COMBAT, MOVE_MEGAHORN, MOVE_TEMPER_FLARE},
    .nature = TRAINER_PARTY_NATURE(NATURE_JOLLY)
    },
    {
    .species = SPECIES_HOUNDSTONE,
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 50,
    .moves = {MOVE_LAST_RESPECTS, MOVE_PLAY_ROUGH, MOVE_BODY_SLAM, MOVE_DESTINY_BOND},
    .nature = TRAINER_PARTY_NATURE(NATURE_ADAMANT)
    }
};
...
static const struct TrainerMon sParty_Tiana[] = {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 9,
    .moves = {MOVE_METRONOME, MOVE_PROTECT, MOVE_NONE, MOVE_NONE},
    .nature = TRAINER_PARTY_NATURE(NATURE_BRAVE)
    },
    {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 9,
    .moves = {MOVE_METRONOME, MOVE_WISH, MOVE_NONE, MOVE_NONE},
    .nature = TRAINER_PARTY_NATURE(NATURE_QUIET)
    }
};
...
static const struct TrainerMon sParty_Janice[] = {
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .iv = TRAINER_PARTY_IVS (31,31,31,31,31,31),
    .moves = {MOVE_AQUA_JET, MOVE_ICE_PUNCH, MOVE_ROLLOUT, MOVE_DEFENSE_CURL},
    .nature = TRAINER_PARTY_NATURE(NATURE_ADAMANT),
    }
};
...
static const struct TrainerMon sParty_Rick[] = {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 7,
    .moves = {MOVE_CHILLING_WATER, MOVE_STRUGGLE_BUG, MOVE_MUD_SLAP, MOVE_STICKY_WEB},
    .nature = TRAINER_PARTY_NATURE(NATURE_MODEST)
    },
    {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 7,
    .moves = {MOVE_DISCHARGE, MOVE_SIGNAL_BEAM, MOVE_GIGA_DRAIN, MOVE_THUNDER_WAVE},
    .nature = TRAINER_PARTY_NATURE(NATURE_TIMID)
    },
    {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 7,
    .moves = {MOVE_VENOSHOCK, MOVE_INFESTATION, MOVE_TOXIC_SPIKES, MOVE_PROTECT},
    .nature = TRAINER_PARTY_NATURE(NATURE_MODEST)
    },
    {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 7,
    .moves = {MOVE_LEECH_LIFE, MOVE_COUNTER, MOVE_POISON_JAB, MOVE_SILK_TRAP},
    .nature = TRAINER_PARTY_NATURE(NATURE_BRAVE)
    }
};
...
static const struct TrainerMon sParty_WallyMauville[] = {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 34,
    .moves = {MOVE_PSYCHIC, MOVE_MOONBLAST, MOVE_SHADOW_BALL, MOVE_AURA_SPHERE},
    .nature = TRAINER_PARTY_NATURE(NATURE_TIMID)
    }
};
...
static const struct TrainerMon sParty_Darian[] = {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 10,
    .moves = {MOVE_PARABOLIC_CHARGE, MOVE_MUDDY_WATER, MOVE_MUD_SHOT, MOVE_ACID_SPRAY},
    .nature = TRAINER_PARTY_NATURE(NATURE_MODEST)
    }
};
...
static const struct TrainerMon sParty_Coby[] = {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 48,
    .moves = {MOVE_GIGA_DRAIN, MOVE_FLORAL_HEALING, MOVE_REFLECT, MOVE_LIGHT_SCREEN},
    .nature = TRAINER_PARTY_NATURE(NATURE_CALM)
    },
    {
    .species = SPECIES_MILOTIC,
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 46,
    .moves = {MOVE_HYDRO_PUMP, MOVE_ICY_WIND, MOVE_DRAGON_TAIL, MOVE_COIL},
    .nature = TRAINER_PARTY_NATURE(NATURE_BOLD)
    },
    {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 47,
    .moves = {MOVE_RETURN, MOVE_HAMMER_ARM, MOVE_ICE_PUNCH, MOVE_COACHING},
    .nature = TRAINER_PARTY_NATURE(NATURE_JOLLY)
    }
};
...
static const struct TrainerMon sParty_TabithaMagmaHideout[] = {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 79,
    .moves = {MOVE_CLOSE_COMBAT, MOVE_RAGE_FIST, MOVE_GUNK_SHOT, MOVE_ROCK_SLIDE},
    .nature = TRAINER_PARTY_NATURE(NATURE_JOLLY)
    },
    {
    .species = SPECIES_TYRANITAR,
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 80,
    .moves = {MOVE_STONE_EDGE, MOVE_BURN_UP, MOVE_BODY_PRESS, MOVE_EXPLOSION},
    .nature = TRAINER_PARTY_NATURE(NATURE_NAIVE)
    },
    {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 79,
    .moves = {MOVE_FACADE, MOVE_EARTHQUAKE, MOVE_CRUNCH, MOVE_PLAY_ROUGH},
    .nature = TRAINER_PARTY_NATURE(NATURE_ADAMANT)
    },
    {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 79,
    .moves = {MOVE_FLASH_CANNON, MOVE_ACROBATICS, MOVE_METEOR_BEAM, MOVE_EARTHQUAKE},
    .nature = TRAINER_PARTY_NATURE(NATURE_BRAVE)
    },
    {
    ...
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 79,
    .moves = {MOVE_FLAMETHROWER, MOVE_STEAM_ERUPTION, MOVE_WEATHER_BALL, MOVE_EARTHQUAKE},
